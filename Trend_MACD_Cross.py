...
def signal(Data, macd_line, macd_signal, buy, sell):
    ...
    for i in range(len(Data)):
        if Data[i, macd_line] > Data[i, macd_signal] and Data[i - 1, macd_line] < Data[i, macd_signal]:
            Data[i, buy] = 1
            
        elif Data[i, macd_line] < Data[i, macd_signal] and Data[i - 1, macd_line] > Data[i, macd_signal]:
            Data[i, sell] = -1 
